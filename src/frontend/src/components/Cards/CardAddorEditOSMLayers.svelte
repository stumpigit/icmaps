<script>
  ...
  $: {
    if ((bbuppercornerx!="") && (bbuppercornery!="") && (bblowercornerx!="") && (bblowercornery!="")) tmsURLSelected();
  }

  function tmsURLSelected() {
    selectedTMS = epsg3857tms.TileMatrixSet[0];
...
<form>
  <h6 class="text-blueGray-400 text-sm mt-3 mb-6 font-bold uppercase">
    From an existing ZYX-Tile Server (like OSM)
  </h6>
      ...
      <div class="w-full lg:w-9/12 px-4">
        <div class="relative w-full mb-3">
          <label
            ...
            for="grid-username"
          >
            GetCapabilities-Url (in form of
            https://xxx.com/&lbrace;tilematrix&rbrace;/&lbrace;tilecol&rbrace;/&lbrace;tilerow&rbrace;.png)
          </label>
          <input
            id="grid-username"
            type="text"
